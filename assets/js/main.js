jQuery(function($){
	...
	/** Sticky Menu **/
	if( typeof cb_params != 'undefined' && cb_params.sticky_header == 1 ){
		ts_sticky_menu();
	}
	...
	if( typeof cb_params != 'undefined' && cb_params.product_name_min_height == 1 ){
	...
	if( typeof cb_params != 'undefined' && cb_params.ajax_add_to_cart == 1 && !$('body').hasClass('woocommerce-cart') ){
	...
	/* Search */
	if( typeof cb_params != 'undefined' && cb_params.ajax_search == 1 ){
		ts_ajax_search();
	}
	...
	if( !$('body').hasClass('woocommerce-cart') ){
		$(document.body).on('adding_to_cart', function( e, $button, data ){
			if( wc_add_to_cart_params.cart_redirect_after_add == 'no' ){
				if( typeof cb_params != 'undefined' && cb_params.add_to_cart_effect == 'show_popup' && typeof $button != 'undefined' ){
		...
		$(document.body).on('added_to_cart', function( e, fragments, cart_hash, $button ){
			/* Show Cart Sidebar */
			if( typeof cb_params != 'undefined' && cb_params.show_cart_after_adding == 1 ){
				$('.shopping-cart-wrapper .cart-control').trigger('click');
				return;
			}
			/* Cart Fly Effect */
			if( typeof cb_params != 'undefined' && typeof $button != 'undefined' ){
				if( cb_params.add_to_cart_effect == 'fly_to_cart' ){
				...
				if( cb_params.add_to_cart_effect == 'show_popup' ){
					var container = $('#ts-add-to-cart-popup-modal');
...
function ts_update_tini_wishlist(){
	...
	jQuery.ajax({
		type : 'POST',
		url : cb_params.ajax_url,
		data : {action : 'cb_update_header_wishlist'},
		success : function(response){
